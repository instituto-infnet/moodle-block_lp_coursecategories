...
$url = new moodle_url('/blocks/lp_coursecategories/full_report_test.php', $params);
...
if (has_capability('moodle/site:viewreports', $context)) {
    ...
    $output = $PAGE->get_renderer('block_lp_coursecategories_test');
    $page = new \block_lp_coursecategories\output\plan_list_test($user);

    echo $output->header() . $OUTPUT->heading($title);
    echo $output->render_full_report_test($page);
    echo $output->footer();
}
